                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="left-image">
                                <img src="img/dinner_menu.jpg" alt="Lunch Menu" class="img-responsive" style="max-width: 100%; height: 510px; object-fit: cover; border-radius: 10px;">
                            </div>
                        </div>
                                ...
                                @foreach ($data as $key => $record)
                                    <div class="item">
                                        <div class="food-item" style="border: 1px solid #ddd; padding: 15px; margin-bottom: 15px; border-radius: 8px;">
                                            <img src="{{ asset('Dinner/' . $record->menu_image) }}" alt="Not Found" class="img-responsive" style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px;">

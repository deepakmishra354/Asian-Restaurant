            ...
            <div class="row">
               ...
               <div class="card">
                  <div class="card-header d-flex justify-content-between align-items-center">
                     <h4>Blog Table</h4>
                    <a href="{{route('blog-form')}}"> <button class="btn btn-outline-primary mr-5" "> Add Blog + </button></a> 
                     </div>
                     <div class="card-body">
                              ...
                              <tbody>
                                 <tr>
                                  ...
                                  @foreach($data as $key => $record) <tr>
                                    <td>{{$key +1}}</td>
                                    <td>{{$record->blog_title}}</td>
                                    <td>{{$record->blog_header}}</td>
                                    <td>{{$record->blog_description}}</td>
                                    <td> <img src="{{ asset('Blog/' . $record->blog_image) }}" style="height: 70px; width: 100px; border-radius: 50%;" alt="Circular Image"> <!-- {{$record->s_image}} --> </td>

            ...
            <div class="row">
               ...
               <div class="card">
                  <div class="card-header d-flex justify-content-between align-items-center">
                     <h4>Menu Dinner Table</h4>
                     <a href="{{route('menu-dinner-form')}}"> <button class="btn btn-outline-primary mr-5" > Add Dinner + </button></a> 
                              ...
                              <tbody>
                                 <tr>
                                  ...
                                  @foreach($data as $key => $record) <tr>
                                    ...
                                    <td> <img src="{{ asset('Dinner/' . $record->menu_image) }}" style="height: 70px; width: 100px; border-radius: 50%;" alt="Circular Image"> <!-- {{$record->s_image}} --> </td>
